...
function Navbar() {
  return (
    ...
    <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a className="navbar-brand brand-logo" href="/ndex.html"><image src={logoSvg} alt="logo" /></a>
      <a className="navbar-brand brand-logo-mini" href="/ndex.html"><image src={logoMiniSvg} alt="logo" /></a>
    </div>
          ...
          <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
            ...
            <a className="dropdown-item preview-item" href="/">
              <div className="preview-thumbnail">
                <image src={face4Jpg} alt="image" className="profile-pic"/>
              </div>
