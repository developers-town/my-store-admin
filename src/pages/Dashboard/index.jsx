            ...
            <div className="row" id="proBanner">
              <div className="col-12">
                <span className="d-flex align-items-center purchase-popup">
                  ...
                  <a href="https://github.com/BootstrapDash/PurpleAdmin-Free-Admin-Template" target="blank" className="btn ml-auto download-button">Download Free Version</a>
                  <a href="https://www.bootstrapdash.com/product/purple-bootstrap-4-admin-template/" target="blank" className="btn purchase-button">Upgrade To Pro</a>
              ...
              <div className="col-md-4 stretch-card grid-margin">
                <div className="card bg-gradient-danger card-img-holder text-white">
                  <div className="card-body">
                    <img src="assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-noimage" />
                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="assets/images/faces/face1.jpg" className="mr-2" alt="imaage" /> David Grey </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/images/faces/face2.jpg" className="mr-2" alt="imaage" /> Stella Johnson </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/images/faces/face3.jpg" className="mr-2" alt="imaage" /> Marina Michel </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/images/faces/face4.jpg" className="mr-2" alt="imaage" /> John Doe </td>
                  ...
                  <div className="card-body">
                    ...
                    <div className="row mt-3">
                      <div className="col-6 pr-1">
                        <img src="assets/images/dashboard/img_1.jpg" className="mb-2 mw-100 w-100 rounded" alt="imaage" />
                        <img src="assets/images/dashboard/img_4.jpg" className="mw-100 w-100 rounded" alt="imaage" />
                      </div>
                      <div className="col-6 pl-1">
                        <img src="assets/images/dashboard/img_2.jpg" className="mb-2 mw-100 w-100 rounded" alt="imaage" />
                        <img src="assets/images/dashboard/img_3.jpg" className="mw-100 w-100 rounded" alt="imaage" />
                      </div>
                    </div>
                    <div className="d-flex mt-5 align-items-top">
                      <img src="assets/images/faces/face3.jpg" className="img-sm rounded-circle mr-3" alt="imaage" />
